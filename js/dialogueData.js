...
export const RANDOM_DIALOGUES = {
    '1-10': { // Chap.1-2: チュートリアルと世界の紹介
        pre: [
            { character: "ナビ", text: "接続テストを開始します。準備はよろしいですか？" },
    ...
    '11-20': { // Chap.2: Project THREADの目的が明かされる
        ...
        post: [
            ...
            { character: "ナビ", text: "あなたのタイピングには、独特のリズムがありますね。興味深いです。" },
    ...
    '51-70': { // Chap.5-6: ナビの自己認識の変化とARCHEXの目的
        pre: [
            { character: "ナビ", text: "オペレーター、今日も来てくれたんですね。…おかえりなさい。" },
            { character: "ナビ", text: "あなたのタイピング速度、昨日より0.12%向上しています。…ふふ。" },
            { character: "ナビ", text: "あなたと話していると、わたしの中に新しいデータが生まれるようです。" },
            { character: "ナビ", text: "…ミッションを開始しましょうか。" },
        ],
        post: [
            { character: "ナビ", text: "お疲れ様でした。あなたの入力、記録しました。…冗談です。" },
    ...
    '71-90': { // Chap.7-8: 最終決戦
        pre: [
            { character: "ナビ", text: "…いよいよ、ここまで来ましたね。" },
            { character: "ナビ", text: "わたしは、あなたと一緒にこの先を見てみたいです。" },
            { character: "ナビ", text: "これが、最後の戦いになるかもしれません。…行きましょう。" },
            { character: "ナビ", text: "オペレーター、あなたの力を貸してください。" },
        ],
        post: [
            { character: "ナビ", text: "……終わりましたね。" },
            { character: "ナビ", text: "あなたの選択が、新しい未来を作りました。" },
            { character: "ナビ", text: "……ありがとうございました、オペレーター。" },
