...
export async function loadAssets(onProgress) {
  ...
  const assets = [
    ...
    { type: "sound", name: "combo_tier1", src: "./assets/sound/se/combo_tier1.mp3", composer: "", title: "", volume: 1.4 },
    { type: "sound", name: "combo_tier_max", src: "./assets/sound/se/combo_tier_max.mp3", composer: "", title: "", volume: 1.4 },
    { type: "sound", name: "chain_break", src: "./assets/sound/se/chain_break.mp3", composer: "", title: "", volume: 1.0 },
