...
export const QUEST_MAP = {
    WORLD1: {
        ...
        nodes: [
            { id: "W1_Q1",  name: "接続テスト", stage: "STAGE1", next: ["W1_Q2", "W1_TEST"], pos: { x: 100, y: 350 } },
            //rewordはtestでいれている。
            { id: "W1_TEST",  name: "テスト", stage: "TESTSTAGE", next: [], pos: { x: 100, y: 100 },reward: { type: "slot", value: 1 }, enableRandomDialogue: true }, 
            { id: "W1_Q2",  name: "パケットの海", stage: "STAGE2", next: ["W1_Q3"], pos: { x: 140, y: 290 } },
            { id: "W1_Q3",  name: "Cookie採取", stage: "STAGE3", next: ["W1_Q4"], pos: { x: 180, y: 230 }, enableRandomDialogue: true },
            { id: "W1_Q4",  name: "ログ解析", stage: "STAGE4", next: ["W1_Q5"], pos: { x: 220, y: 170 } , enableRandomDialogue: true},
            { id: "W1_Q5",  name: "バッファ浄化", stage: "STAGE5", next: ["W1_Q6"], pos: { x: 250, y: 110 } , enableRandomDialogue: true},
            { id: "W1_Q6",  name: "不要なキャッシュ", stage: "STAGE6", next: ["W1_Q7"], pos: { x: 285, y: 140 } , enableRandomDialogue: true},
            { id: "W1_Q7",  name: "セッション維持", stage: "STAGE7", next: ["W1_Q8"], pos: { x: 305, y: 180 }, enableRandomDialogue: true },
            { id: "W1_Q8",  name: "ゴミ捨て場", stage: "STAGE8", next: ["W1_Q9"], pos: { x: 325, y: 220 } },
            { id: "W1_Q9",  name: "警告の予兆", stage: "STAGE9", next: ["W1_Q10"], pos: { x: 345, y: 260 } },
            { id: "W1_Q10", name: "最終チェックポイント", stage: "STAGE10", next: ["W1_MiniBoss_1"], pos: { x: 350, y: 300 } },
            { 
                id: "W1_MiniBoss_1", 
                name: "Adware King", 
                stage: "W1_MID_BOSS_1", 
    ...
    WORLD2: {
        ...
        nodes: [
            ...
            { id: "W2_Q39", name: "深淵の監視者", stage: "STAGE39", next: ["W2_MiniBoss_4"], pos: { x: 440, y: 740 } },
            ...
            { id: "W2_Q49", name: "虚像の番人", stage: "STAGE49", next: ["W2_MiniBoss_5"], pos: { x: 840, y: 100 } },
            { id: "W2_MiniBoss_5", name: "Void", stage: "W2_MID_BOSS_5", next: ["W2_Q51"], pos: { x: 880, y: 50 } },
            { id: "W2_Q51", name: "最後の平穏", stage: "STAGE51", next: ["W2_Q52"], pos: { x: 920, y: 100 } },
            ...
            { id: "W2_Q59", name: "コアの守護者", stage: "STAGE59", next: ["W2_MiniBoss_6"], pos: { x: 1240, y: 740 } },
    ...
    WORLD3: {
        ...
        nodes: [
            ...
            { id: "W3_Q69", name: "遺跡の守護者", stage: "STAGE69", next: ["W3_MiniBoss_7"], pos: { x: 1310, y: 475 } },
            ...
            { id: "W3_Q79", name: "中心核の脈動", stage: "STAGE79", next: ["W3_MiniBoss_8"], pos: { x: 705, y: 250 } },
