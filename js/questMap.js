...
export const QUEST_MAP = {
    WORLD1: {
        ...
        nodes: [
            { id: "W1_Q1",  name: "接続テスト1", stage: "STAGE1", next: ["W1_Q2", "W1_TEST","W1_DEFENSE_1"], pos: { x: 100, y: 350 }, enableRandomDialogue: true },
            { id: "W1_DEFENSE_1", name: "防衛戦線", stage: "DEFENSE_1", next: [], pos: { x: 100, y: 220 }, enableRandomDialogue: true },
            ...
            { id: "W1_Q15", name: "アクセス権限", stage: "STAGE15", next: ["W1_Q16"], pos: { x: 430, y: 900 }, enableRandomDialogue: true },
            { id: "W1_Q16", name: "基盤システム", stage: "STAGE16", next: ["W1_Q17"], pos: { x: 470, y: 895 }, enableRandomDialogue: true },
            { id: "W1_Q17", name: "自己参照AI", stage: "STAGE17", next: ["W1_Q18"], pos: { x: 510, y: 790 }, enableRandomDialogue: true },
            { id: "W1_Q18", name: "脆弱性スキャン", stage: "STAGE18", next: ["W1_Q19"], pos: { x: 550, y: 685 }, enableRandomDialogue: true },
            { id: "W1_Q19", name: "ステルス侵食", stage: "STAGE19", next: ["W1_Q20"], pos: { x: 590, y: 580 }, enableRandomDialogue: true },
            ...
            { id: "W1_Q25", name: "存在証明", stage: "STAGE25", next: ["W1_Q26"], pos: { x: 1000, y: 200 }, enableRandomDialogue: true },
            { id: "W1_Q26", name: "傍受", stage: "STAGE26", next: ["W1_Q27"], pos: { x: 1060, y: 225 }, enableRandomDialogue: true },
            { id: "W1_Q27", name: "クエリ", stage: "STAGE27", next: ["W1_Q28"], pos: { x: 1120, y: 250 }, enableRandomDialogue: true },
    ...
    WORLD2: {
        ...
        nodes: [
            ...
            { id: "W2_Q45", name: "例外処理", stage: "STAGE45", next: ["W2_Q46"], pos: { x: 680, y: 420 }, enableRandomDialogue: true },
            ...
            { id: "W2_Q55", name: "共存モデル", stage: "STAGE55", next: ["W2_Q56"], pos: { x: 1080, y: 420 }, enableRandomDialogue: true },
    ...
    WORLD3: {
        ...
        nodes: [
            ...
            { id: "W3_Q75", name: "ハンドオーバー", stage: "STAGE75", next: ["W3_Q76"], pos: { x: 350, y: 800 }, enableRandomDialogue: true },
            ...
            { id: "W3_Q85", name: "完成", stage: "STAGE85", next: ["W3_Q86"], pos: { x: 480, y: 475 }, enableRandomDialogue: true },
            { id: "W3_Q86", name: "エラー", stage: "STAGE86", next: ["W3_Q87"], pos: { x: 705, y: 380 }, enableRandomDialogue: true },
