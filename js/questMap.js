...
export const QUEST_MAP = {
    WORLD1: {
        ...
        nodes: [
            ...
            //rewordはtestでいれている。
            { id: "W1_TEST",  name: "テスト", stage: "TESTSTAGE", next: [], pos: { x: 100, y: 100 },reward: { type: "slot", value: 1 },  }, 
            { id: "W1_Q2",  name: "パケットの海", stage: "STAGE2", next: ["W1_Q3"], pos: { x: 140, y: 290 } },
            { id: "W1_Q3",  name: "Cookie採取", stage: "STAGE3", next: ["W1_Q4"], pos: { x: 180, y: 230 } },
            { id: "W1_Q4",  name: "ログ解析", stage: "STAGE4", next: ["W1_Q5"], pos: { x: 220, y: 170 } },
            { id: "W1_Q5",  name: "バッファ浄化", stage: "STAGE5", next: ["W1_Q6"], pos: { x: 250, y: 110 } },
            { id: "W1_Q6",  name: "不要なキャッシュ", stage: "STAGE6", next: ["W1_Q7"], pos: { x: 285, y: 140 } },
            { id: "W1_Q7",  name: "セッション維持", stage: "STAGE7", next: ["W1_Q8"], pos: { x: 305, y: 180 } },
